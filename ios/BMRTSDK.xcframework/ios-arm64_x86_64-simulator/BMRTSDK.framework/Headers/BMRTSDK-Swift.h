...
#ifndef BMRTSDK_SWIFT_H
#define BMRTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BMRTSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC7BMRTSDK4BMRT") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface BMRT : NSObject
...
SWIFT_CLASS("_TtC7BMRTSDK16BMRTNetworkTrace")
@interface BMRTNetworkTrace : NSObject
+ (BMRTNetworkTrace * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (void)start;
...
SWIFT_CLASS("_TtC7BMRTSDK26BMRTNetworkTracingProtocol")
@interface BMRTNetworkTracingProtocol : NSURLProtocol
...
@interface BMRTNetworkTracingProtocol (SWIFT_EXTENSION(BMRTSDK)) <NSURLSessionDataDelegate>
...
@interface UIWindow (SWIFT_EXTENSION(BMRTSDK))
